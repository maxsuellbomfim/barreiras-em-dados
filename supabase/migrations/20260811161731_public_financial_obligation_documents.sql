-- Amplia o catálogo financeiro com as fontes oficiais usadas para apurar
-- obrigações municipais. A função publica documentos e evidências, nunca um
-- saldo de dívida inferido a partir de um relatório isolado.
...
begin
  ...
  select
    ...
    'public-finance-documents/1.3.0',
...
comment on function api.get_public_finance_documents(integer, text) is
  'Catálogo financeiro versionado com RREO, RGF, balancetes e contas anuais. Não calcula saldo de dívida.';
