...
-- Busca pela identidade da edição, sem depender de o OCR repetir o cabeçalho.
-- Mantém assinatura, permissões, lote canônico e texto literal existentes.
...
comment on function api.search_integral_gazette_editions(text, integer, integer) is
  'Busca literal paginada: número ou número/ano prioriza a edição; termos selecionam edições completas do lote público canônico.';
