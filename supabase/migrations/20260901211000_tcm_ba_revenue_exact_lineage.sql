-- Amplia a linhagem TCM-BA já validada para o demonstrativo analítico de
-- receita PCMGE016, sem misturá-lo aos documentos do portal municipal.
...
as $function$
  select exists (
    ...
    where origin.id = $1
      ...
      and left(origin.payload ->> 'category', 8)
        in ('PCMGE015', 'PCMGE016')
...
comment on function finance.has_tcm_ba_document_lineage(uuid, uuid) is
  'Confere registros PCMGE015/PCMGE016, preparação e PDF exato do SIGA/TCM-BA.';
