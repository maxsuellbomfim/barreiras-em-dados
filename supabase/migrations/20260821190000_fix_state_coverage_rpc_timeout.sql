...
comment on function api.get_public_state_amendment_source_coverage() is
  'Cobertura anual sanitizada lida do snapshot privado; nao recalcula a reconciliacao bruta em requisicoes publicas.';
...
values (
  'administrator',
  'migration:fix-state-coverage-rpc-timeout',
  'reconciliation.public_coverage_snapshot_enabled',
  ...
  jsonb_build_object(
    'avoids_raw_reconciliation_at_request_time', true,
    'changes_financial_values', false,
