-- Vincula cada documento financeiro ao registro exato que originou seu
-- download. Uma resposta da API pode conter diversos registros e PDFs filhos;
-- escolher apenas o filho mais recente do artefato pai mistura meses distintos.
...
begin
  ...
  select
    ...
    'public-finance-documents/1.4.0',
...
comment on function api.get_public_finance_documents(integer, text) is
  'Catálogo financeiro com vínculo exato entre registro da API e PDF preservado. Não calcula saldo de dívida.';
