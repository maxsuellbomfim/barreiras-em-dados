-- Endpoint público do PNCP para contratos/empenhos vinculados a uma contratação.
-- A coleta preserva o retorno bruto; a normalização financeira permanece em etapa
-- posterior, depois de validar o contrato observado em produção.
