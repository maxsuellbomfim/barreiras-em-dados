...
comment on function api.get_public_federal_transfer_source_coverage() is
  'Cobertura anual sanitizada das tres series federais; a serie historica conta somente destino territorial confirmado.';
...
values (
  'administrator',
  'migration:fix-federal-coverage-territorial-scope',
