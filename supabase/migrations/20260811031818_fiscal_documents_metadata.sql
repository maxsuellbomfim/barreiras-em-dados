-- Corrige o catalogo publico dos demonstrativos fiscais.
-- RREO/RGF usam ano_ref e informacoes, enquanto os demonstrativos mensais
-- usam ano/mes e titulo/descricao. A camada publica deve preservar essa
-- diferenca sem transformar relatorio bimestral em fechamento mensal.
...
begin
  ...
  select
    ...
    'public-finance-documents/1.2.0',
...
comment on function api.get_public_finance_documents(integer, text) is
  'Catalogo financeiro: ano_ref/informacoes de RREO/RGF sao preservados sem trata-los como fechamento mensal.';
