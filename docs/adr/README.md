...
| ADR | Decisão | Estado |
|---|---|---|
| 0001 | Monólito modular com workers | Aceita |
| 0002 | Camada bruta append-only por hash | Aceita |
| 0003 | Schemas internos e projeção pública | Aceita |
| 0004 | Contratos JSON Schema canônicos | Aceita |
