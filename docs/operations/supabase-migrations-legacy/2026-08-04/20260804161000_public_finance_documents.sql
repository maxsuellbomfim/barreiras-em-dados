-- Financas publicas: publica o catalogo de documentos financeiros preservados
-- pela coleta municipal. Nao transforma PDF em valores silenciosamente.
...
begin
  ...
  select
    ...
    'public-finance-documents/1.0.0'
...
comment on function api.get_public_finance_documents(integer, text) is
  'Catalogo de documentos financeiros oficiais cuja resposta de API foi preservada; valores de PDF ainda exigem extracao validada.';
