# Registro operacional — agosto e setembro de 2026

Conteúdo integral do `docs/CURRENT_STATUS.md` até 21/09/2026, preservado sem
edição quando o documento de estado foi reduzido a um resumo em 23/09/2026.
Cada seção registra uma entrega, a evidência e as limitações daquele momento.
...
pagamentos aos rankings. Ver [caminho de publicação](FNS_PHARMACY_PUBLICATION.md).
...
[`FNS_61659_CANCELLATION_AUDIT.md`](FNS_61659_CANCELLATION_AUDIT.md).
...
[conferência do lote](FNS_66458_ORDER_AUDIT.md).
...
Ver [conferência SAMU](FNS_62079_SAMU_CAPTURE.md).
...
[`FNS_2025_SOURCE_DISCOVERY.md`](FNS_2025_SOURCE_DISCOVERY.md).
...
- Auditoria de 04/09: [achados, correções e prioridades](AUDIT_2026_09_04.md).
