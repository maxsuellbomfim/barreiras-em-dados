...
| Transparência Bahia / SEPLAN-BA | transferências a municípios, despesas e emendas estaduais | P3 | ZIP de execução preservado e normalizado como agregado estadual; replay versionado confirmou 70 autorizações territoriais da LOA 2022-2026, sendo 34 em 2026; o conjunto oficial Transferências Especiais possui conector privado com cinco views e 12.169 registros estruturais validados e normalizador seguro para pagamentos cujo objeto menciona Barreiras, ainda sem projeção pública até reconciliar autoria e esfera; os 13 autores observados na LOA estão ligados a perfis oficiais por crosswalk TSE aprovado, sem confundir autoria histórica, legislatura e Casa atual |
