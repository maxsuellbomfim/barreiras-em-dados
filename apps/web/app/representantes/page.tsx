...
export default async function RepresentativesPage() {
  const result = await getFederalRepresentatives();
      ...
      <section className="section" aria-labelledby="people-title">
        ...
        <div className="coverage-note" role="note">
          ...
          <ul>
            ...
            <li>
              <strong>Deputados estaduais, vereadores, secretários e
              candidaturas</strong>: em construção. Cada grupo entra quando
              houver fonte oficial estruturada e critério de vínculo
