  ...
  return (
    <div className="procurement-explorer">
      <div className="procurement-summary" aria-live="polite">
        <strong>
          {procurements.length} {procurements.length === 1 ? "contratação" : "contratações"} nesta página
        </strong>
        <span>
          {loadedHomologatedTotal > 0
            ? `Soma dos valores homologados nesta página: ${currencyFormatter.format(loadedHomologatedTotal)}`
