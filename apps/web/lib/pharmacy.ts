...
async function callPharmacyRpc(name:'get_public_pharmacy_payments_filtered'|'get_public_pharmacy_coverage_filtered'|'get_public_pharmacy_establishments'|'get_public_pharmacy_refresh',args:object) {
